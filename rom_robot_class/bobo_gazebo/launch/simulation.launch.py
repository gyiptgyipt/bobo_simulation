...
def generate_launch_description():
    ...
    bot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            description_pkg, 'launch', 'sim_robot2_description.launch.py'
    ...
    spawn_robot_node = Node(
        ...
        #aguments=['-database', 'bobo_tall_ros', '-entity', 'bobo_tall_ros',
        arguments=['-file', urdf_file, '-entity', 'bobo_standalone',
        #arguments=[ '-topic', '/robot_description', '-entity', 'bobo',
                   "-x", '0.0',
                   "-y", '0.0',
                   "-z", '0.3'],
        output='screen'
