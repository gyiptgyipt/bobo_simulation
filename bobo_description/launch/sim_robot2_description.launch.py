...
def generate_launch_description():
    ...
    bobo_model = os.getenv('BOBO_MODEL', 'sim_robot2') # robot1 , robot2, sim_robot2
    robot_urdf_name = bobo_model+'_complete.urdf.xacro'
    
    urdf_pkg = get_package_share_directory('bobo_description')
    #urdf_path= os.path.join(urdf_pkg, 'urdf', "urdf.urdf")
    #urdf = open(urdf_path).read()
    xacro_file = os.path.join(urdf_pkg,'urdf', robot_urdf_name)
